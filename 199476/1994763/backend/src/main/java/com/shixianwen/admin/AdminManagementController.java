...
public class AdminManagementController {
    ...
    public record StatusRequest(String status){} public record EnabledRequest(boolean enabled){} public record ReviewRequest(boolean approved,String reason,Long jobId,Integer years,Long experienceId){} public record CertificationEditRequest(String title,String description,Long jobId,Integer years){} public record ReplyRequest(String content){}
