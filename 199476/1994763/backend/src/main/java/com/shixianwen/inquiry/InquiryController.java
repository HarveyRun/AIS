...
public class InquiryController {
    ...
    @PostMapping public ApiResponse<InquiryService.InquiryView> create(@CurrentUser User u, @Valid @RequestBody CreateRequest r) { return ApiResponse.ok(service.create(u.getId(), new InquiryService.CreateCommand(r.answererId(), r.topic(), r.sourceType(), r.question(), r.amount()))); }
